...
namespace biblio_console
{
	class MainClass
	{
		...
		public static void Main (string[] args)
		{
			...
			Livre l4 = new Livre {Titre = "Ce chasseur là",NomAuteur = "Pelot",PrenomAuteur = "Pierre",Edit = "Presses Pocket",Coll = "Science Fiction", Isbn="2266016164",DateDeParutionVF = "1985"};
			Livre l5 = null;
